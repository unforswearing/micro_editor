...
function shellcheck()
  ...
  -- add something about unsaved changes and exiting scratch buffer
  -- this may be better as a .md file a la micro-editor help files
  -- messenger:Error('Shellcheck Scratch Buffer Active.')
...
MakeCommand("shellcheck", "shellcheck.shellcheck")
